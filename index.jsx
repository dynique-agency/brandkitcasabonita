...
import { Anchor, Layout, Type, Palette, Globe, Share2, Copy, Check, X, Menu, Home, Sparkles, MousePointer, Move, Eye, ArrowDown, Wind, Mic2, Hexagon } from 'lucide-react';
...
const BrandLab = () => {
  ...
  const SpotlightEffect = () => {
    ...
    return (
      <div 
        ref={containerRef}
        onMouseMove={handleMouseMove}
        className="relative h-[400px] bg-[#1C1C1C] overflow-hidden cursor-none flex items-center justify-center group"
      >
        {/* The Hidden Content */}
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
           <div className="text-center">
              <span className="block text-[#D4AF37] font-cinzel text-6xl tracking-widest opacity-20 group-hover:opacity-100 transition-opacity duration-300">DISCOVER</span>
              <span className="block text-white font-cormorant italic text-2xl mt-4 opacity-20 group-hover:opacity-100 transition-opacity duration-300">"The beauty in the dark."</span>
           </div>
        </div>
        ...
        <div 
          ...
          style={{
            background: `radial-gradient(circle 150px at ${position.x}px ${position.y}px, transparent 0%, rgba(28, 28, 28, 0.98) 100%)`
          }}
        />
        
        <div className="absolute bottom-8 text-[#A89F91] text-[9px] uppercase tracking-widest pointer-events-none">Move cursor to reveal</div>
      </div>
    );
  };
  ...
  const ScrollTriggerExample = () => {
    ...
    return (
      <div ref={ref} className="bg-[#1C1C1C] text-[#F2F0E9] p-12 relative overflow-hidden h-[400px] flex items-center justify-center">
        ...
        <div className="relative z-10 max-w-lg text-center">
          ...
          <div className={`w-[1px] bg-[#D4AF37] mx-auto mb-8 transition-all duration-[1.5s] ease-in-out ${isVisible ? 'h-24 opacity-100' : 'h-0 opacity-0'}`}></div>
          
          {/* Staggered Text Reveal */}
          <div className="overflow-hidden mb-2">
            <h3 className={`font-cinzel text-3xl md:text-4xl transform transition-transform duration-[1.2s] ease-[cubic-bezier(0.22,1,0.36,1)] delay-300 ${isVisible ? 'translate-y-0' : 'translate-y-full'}`}>
              The Narrative Arrives
            </h3>
          </div>
          
          <div className="overflow-hidden">
            <p className={`font-cormorant italic text-xl text-[#A89F91] transform transition-transform duration-[1.2s] ease-[cubic-bezier(0.22,1,0.36,1)] delay-500 ${isVisible ? 'translate-y-0' : 'translate-y-full'}`}>
  ...
  return (
    <div className="min-h-screen bg-[#F2F0E9] text-[#1C1C1C] font-sans selection:bg-[#D4AF37] selection:text-white flex">
        ...
        <div className={`fixed inset-y-0 left-0 z-50 w-72 bg-white/80 backdrop-blur-xl border-r border-[#E5E5E5] transform ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 transition-transform duration-500 ease-[cubic-bezier(0.25,0.8,0.25,1)]`}>
          <div className="p-10 border-b border-[#E5E5E5]/50 flex justify-between items-center">
            <div className="flex flex-col items-center w-full">
              <Logo className="w-full max-w-[200px] mb-4" variant="header" />
            </div>
          ...
          <nav className="p-8 space-y-1">
            {[
              ...
              { id: 'sensory', label: 'Sensory Identity', icon: Wind }, // NEW
      ...
      {/* Main Stage */}
      <div className={`flex-1 transition-all duration-700 ${!presentationMode ? 'md:ml-72' : 'ml-0'} p-8 md:p-16 lg:p-24 min-h-screen flex flex-col items-center`}>
        ...
        <main className={`max-w-5xl w-full transition-all duration-1000 ${presentationMode ? 'scale-105' : 'scale-100'}`}>
          ...
          {activeTab === 'essence' && (
            <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 space-y-16">
              <header className="text-center space-y-6">
                ...
                <h2 className="font-cinzel text-5xl md:text-7xl text-[#1C1C1C] leading-tight">The Art of<br/><span className="gold-text-gradient italic font-cormorant pr-2">Slow Living</span></h2>
                <div className="w-24 h-[1px] bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent mx-auto"></div>
              </header>

              {/* NEW: Manifesto Card */}
              <div className="max-w-3xl mx-auto bg-white p-12 shadow-xl border border-[#D4AF37]/20 relative">
                 <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-transparent via-[#D4AF37] to-transparent"></div>
                 <h3 className="font-montserrat text-[10px] uppercase tracking-widest text-[#A89F91] text-center mb-8">The Casa Bonita Manifesto</h3>
                 <p className="font-cormorant text-2xl md:text-3xl text-center leading-relaxed text-[#1C1C1C]">
                   "We believe that true luxury is not about excess, but about absence. The absence of noise, the absence of rush, and the absence of worry. We are the guardians of your peace, and the stewards of your legacy."
                 </p>
              ...
              <div className="grid md:grid-cols-2 gap-16 relative">
                ...
                <div className="text-center md:text-right md:pr-12 space-y-6">
                  <h3 className="font-cinzel text-2xl text-[#1C1C1C]">For The Guest</h3>
                  <p className="font-cormorant text-2xl text-[#6B705C] italic">"Sanctuary."</p>
                  <p className="font-montserrat font-light text-sm leading-8 text-[#A89F91]">
                    We offer more than keys; we offer a pause in time. Hotel-grade hospitality meets the soulful silence of a private Mallorcan estate.
                  </p>
                </div>

                <div className="text-center md:text-left md:pl-12 space-y-6">
                  <h3 className="font-cinzel text-2xl text-[#1C1C1C]">For The Owner</h3>
                  <p className="font-cormorant text-2xl text-[#6B705C] italic">"Stewardship."</p>
                  <p className="font-montserrat font-light text-sm leading-8 text-[#A89F91]">
                    Uncompromising care for your asset. We act as curators of your property, ensuring profitability without the operational burden.
                  </p>
                </div>
              </div>
            </div>
          ...
          {activeTab === 'sensory' && (
             <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 space-y-16">
              <header className="border-b border-[#D4AF37]/20 pb-8">
                ...
                <h2 className="font-cinzel text-4xl text-[#1C1C1C] mt-2">Beyond the Visual</h2>
              </header>

              <div className="grid md:grid-cols-3 gap-8">
                {/* Scent */}
                <div className="bg-white p-8 border-t-2 border-[#D4AF37] shadow-lg group hover:-translate-y-2 transition-transform duration-500">
                ...
                {/* Sound */}
                <div className="bg-white p-8 border-t-2 border-[#1C1C1C] shadow-lg group hover:-translate-y-2 transition-transform duration-500">
                ...
                {/* Touch */}
                <div className="bg-white p-8 border-t-2 border-[#6B705C] shadow-lg group hover:-translate-y-2 transition-transform duration-500">
            ...
            <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 space-y-16">
               <header className="border-b border-[#D4AF37]/20 pb-8 mb-12 flex justify-between items-end">
                <div>
                  ...
                  <h2 className="font-cinzel text-4xl text-[#1C1C1C] mt-2">The Brand Seal</h2>
                </div>
                {!presentationMode && (
              ...
              <div className="grid gap-16">
                {/* Primary Logo Hero */}
                <div className="bg-white p-16 md:p-24 flex flex-col items-center justify-center shadow-2xl shadow-[#A89F91]/10 relative border border-[#F2F0E9] group">
                  <div className="absolute top-6 left-6 text-[10px] font-montserrat text-[#A89F91] uppercase tracking-[0.3em]">Hover to Animate</div>
                ...
                <div className="flex justify-center">
                   <div className="bg-gradient-to-br from-[#D4AF37] to-[#B08D55] p-16 flex flex-col items-center justify-center text-white relative shadow-2xl">
                       <span className="absolute top-6 left-6 text-[10px] font-montserrat text-white/50 uppercase tracking-[0.3em]">Favicon / Social</span>
          ...
          {activeTab === 'palette' && (
             ...
             <header className="border-b border-[#D4AF37]/20 pb-8">
              ...
              <h2 className="font-cinzel text-4xl text-[#1C1C1C] mt-2">Earth, Sea & Stone</h2>
            </header>

            <div className="grid gap-8">
              {palette.map((color, index) => (
                <div key={color.name} className="group flex flex-col md:flex-row items-stretch overflow-hidden rounded-sm shadow-sm hover:shadow-xl transition-all duration-500 bg-white">
                  ...
                  <div className="p-8 md:w-2/3 flex flex-col justify-center">
                    <h3 className="font-cinzel font-bold text-2xl text-[#1C1C1C] mb-1">{color.name}</h3>
          ...
          {activeTab === 'typography' && (
            <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 space-y-16">
               <header className="pb-8 border-b border-[#E5E5E5]">
                ...
                <h2 className="font-cinzel text-4xl text-[#1C1C1C] mt-2">The "Triple Threat"</h2>
              </header>

              <div className="bg-white p-12 shadow-xl border-l-4 border-[#D4AF37] space-y-12">
                 <div className="flex flex-col md:flex-row md:items-baseline border-b border-[#F2F0E9] pb-8">
                    ...
                    <h1 className="font-cinzel text-5xl md:text-6xl text-[#1C1C1C]">Cinzel Regular</h1>
                 ...
                 <div className="flex flex-col md:flex-row md:items-baseline border-b border-[#F2F0E9] pb-8">
                    ...
                    <h2 className="font-cormorant italic text-4xl md:text-5xl text-[#6B705C]">Cormorant Garamond</h2>
                 ...
                 <div className="flex flex-col md:flex-row md:items-baseline">
                    ...
                    <p className="font-montserrat font-light text-lg text-[#1C1C1C] max-w-xl">
               ...
               {/* Live Tester */}
               <div className="bg-[#1C1C1C] p-12 text-[#F2F0E9] rounded-sm">
                  <h4 className="text-[10px] uppercase tracking-[0.3em] text-[#D4AF37] mb-8">Contextual Example</h4>
                  <h2 className="font-cinzel text-4xl mb-4">{demoText}</h2>
                  <p className="font-cormorant italic text-2xl text-[#A89F91] mb-6">"Where heritage meets silence."</p>
                  
                  <input 
                    type="text" 
                    value={demoText}
                    onChange={(e) => setDemoText(e.target.value)}
                    className="w-full mt-12 bg-transparent border-b border-white/10 p-2 text-center font-cinzel text-xl focus:outline-none focus:border-[#D4AF37] transition-colors text-white/50"
          ...
          {activeTab === 'voice' && (
             ...
             <header className="border-b border-[#D4AF37]/20 pb-8">
              ...
              <h2 className="font-cinzel text-4xl text-[#1C1C1C] mt-2">The Trilingual Shift</h2>
            </header>
            ...
            <div className="bg-white p-16 border-t-4 border-[#D4AF37] shadow-2xl text-center max-w-2xl mx-auto relative">
              <div className="absolute top-4 right-4 opacity-10"><Globe size={64} /></div>
              <h3 className="font-cinzel text-3xl mb-8 text-[#1C1C1C] leading-snug">
                "{voiceExamples[lang].headline}"
              </h3>
              <p className="font-cormorant text-2xl italic text-[#6B705C] mb-12 leading-relaxed">
                {voiceExamples[lang].body}
              </p>
              <button className="bg-[#1C1C1C] text-white px-10 py-4 font-montserrat text-[10px] tracking-[0.3em] uppercase hover:bg-[#D4AF37] transition-colors shadow-lg">
          ...
          {/* DIGITAL EXPERIENCE TAB - NEW & AWARD WINNING */}
          {activeTab === 'digital' && (
            <div className="space-y-24 pb-20">
               <header className="border-b border-[#D4AF37]/20 pb-8 animate-blur-in">
                ...
                <h2 className="font-cinzel text-4xl md:text-6xl text-[#1C1C1C] mt-4 leading-tight">
                   The Interactive<br/><span className="font-cormorant italic text-[#6B705C]">Symphony</span>
                </h2>
                <p className="mt-6 font-montserrat text-[#666] max-w-lg leading-relaxed">
                   In the ultra-premium segment, web design is not about information; it is about feeling. We use "Micro-interactions" to create weight, depth, and focus.
                </p>
              </header>
              ...
              <section className="grid md:grid-cols-12 gap-12 items-center">
                 ...
                 <div className="md:col-span-8 bg-[#1C1C1C] h-64 flex items-center justify-center overflow-hidden relative">
                    ...
                    <h2 className="text-white font-cormorant italic text-4xl md:text-5xl animate-blur-in relative z-10 text-center">
                       "Silence is the<br/>ultimate luxury."
                    </h2>
                 </div>
              </section>

              {/* EFFECT 2: Magnetic Physics */}
              <section className="grid md:grid-cols-12 gap-12 items-center">
                 <div className="md:col-span-4 md:order-2">
                    <span className="text-[10px] text-[#D4AF37] uppercase tracking-widest font-bold mb-2 block">02. The Touch</span>
                    <h3 className="font-cinzel text-2xl mb-4">Magnetic Physics</h3>
                    <p className="text-xs text-[#666] leading-6 font-montserrat">
                       Buttons shouldn't feel like pixels. They should feel like physical objects. This "Magnetic" button pulls towards your cursor, creating a subconscious connection of "gravity" and importance.
                    </p>
                 </div>
                 <div className="md:col-span-8 md:order-1 bg-[#FDFDFB] border border-[#E5E5E5] h-64 flex items-center justify-center">
                    <MagneticButton className="bg-[#1C1C1C] text-[#D4AF37] px-12 py-5 rounded-full font-montserrat text-xs uppercase tracking-[0.3em] shadow-2xl hover:bg-[#D4AF37] hover:text-[#1C1C1C] transition-colors">
                       Inquire Now
                    </MagneticButton>
                 </div>
              </section>
              ...
              <section className="grid md:grid-cols-12 gap-12 items-center">
                 ...
                 <div className="md:col-span-8 h-80 relative group overflow-hidden cursor-pointer">
                    {/* Background Layer */}
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                       <div className="bg-white/10 backdrop-blur-md border border-white/20 p-8 transform group-hover:translate-y-[-10px] transition-transform duration-700">
                          <span className="text-white font-cinzel text-3xl tracking-widest">FINCA SOL</span>
                       </div>
                    </div>
                 </div>
              </section>
              ...
              <section className="grid md:grid-cols-12 gap-12 items-center">
                 <div className="md:col-span-4">
                    ...
                    <p className="text-xs text-[#666] leading-6 font-montserrat">
                       True luxury is often hidden. This effect uses the user's curiosity to reveal content. It transforms a passive screen into an active exploration, creating a sense of intimacy and exclusivity.
                    </p>
                 </div>
